...
robocopy SDL\VisualC\x%Arch%\Release\ build\SDL2\bin\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
robocopy SDL\include\ build\SDL2\include\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
...
robocopy SDL_image\VisualC\x%Arch%\Release\ build\SDL_image\bin\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
...
robocopy SDL_mixer\VisualC\x%Arch%\Release\ build\SDL_mixer\bin\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
robocopy SDL_mixer\include\ build\SDL_mixer\include\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
...
robocopy SDL_net\VisualC\x%Arch%\Release\ build\SDL_net\bin\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
...
robocopy SDL_ttf\VisualC\x%Arch%\Release\ build\SDL_ttf\bin\ /copyall /e /ns /nc /nfl /ndl /np /njh /njs
...
:: combined build directory
pushd build
mkdir combined combined\lib combined\bin combined\include
for /r %%a in (*.lib) do xcopy "%%a" combined\lib\ /i /Y /C /Q
for /r %%a in (*.dll) do xcopy "%%a" combined\bin\ /i /Y /C /Q
for /r %%a in (*.h) do xcopy "%%a" combined\include\ /i /Y /C /Q
popd
